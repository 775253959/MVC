...
{
    public class AppDomainTypeSearcher:ITypeSearcher
    {
        ...
        public IEnumerable<Type> SearchClassesOfType<T>(bool onlyConcreteClasses = true)
        {
            return SearchClassesOfType(typeof(T), onlyConcreteClasses);
        }

        public IEnumerable<Type> SearchClassesOfType(Type assignTypeFrom, bool onlyConcreteClasses = true)
        {
            return SearchClassesOfType(assignTypeFrom, GetAssemblies(), onlyConcreteClasses);
        }

        public IEnumerable<Type> SearchClassesOfType<T>(IEnumerable<Assembly> assemblies, bool onlyConcreteClasses = true)
        {
            return SearchClassesOfType(typeof(T), assemblies, onlyConcreteClasses);
        }

        public IEnumerable<Type> SearchClassesOfType(Type assignTypeFrom, IEnumerable<Assembly> assemblies, bool onlyConcreteClasses = true)
        {
        ...
        public IEnumerable<Type> SearchClassesOfType<T, TAssemblyAttribute>(bool onlyConcreteClasses = true) where TAssemblyAttribute : Attribute
        {
            var found = SearchAssembliesWithAttribute<TAssemblyAttribute>();
            return SearchClassesOfType<T>(found, onlyConcreteClasses);
        }

        public IEnumerable<Assembly> SearchAssembliesWithAttribute<T>()
        {
            return SearchAssembliesWithAttribute<T>(GetAssemblies());
        }
        ...
        public IEnumerable<Assembly> SearchAssembliesWithAttribute<T>(IEnumerable<Assembly> assemblies)
        {
        ...
        public IEnumerable<Assembly> FindAssembliesWithAttribute<T>(DirectoryInfo assemblyPath) {
            var assemblies = (from f in Directory.GetFiles(assemblyPath.FullName, "*.dll")
                              select Assembly.LoadFrom(f)
                                  ...
                                  where customAttributes.Any()
                                  select assembly).ToList();
            return SearchAssembliesWithAttribute<T>(assemblies);
        }
